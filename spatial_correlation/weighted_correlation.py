...
class WeightedCorr:
    def __init__(self, xyw=None, x=None, y=None, w=None, df=None, wcol=None):
        """ Weighted Correlation class. Either supply xyw, (x, y, w), or (df, wcol).
        Call the class to get the result, i.e.:
    ...
    def __call__(self, method='pearson'):
        """
        :param method: Correlation method to be used: 'pearson' for pearson r, 'spearman' for spearman
